    ...
    >
      <header className="flex shrink-0 items-start justify-between gap-4 border-b border-border px-5 py-4">
        ...
        <button
          ...
          onClick={onClose}
          aria-label="Close"
          className="-mr-1 shrink-0 rounded-[length:var(--radius-sm)] px-2 py-1 text-[length:var(--text-caption)] text-text-muted transition-colors duration-[var(--motion-fast)] hover:bg-surface hover:text-text-primary"
        >
          Close
        </button>
      </header>
