...
export default function NotFound() {
  return (
    <main className="mx-auto flex min-h-dvh max-w-lg flex-col justify-center px-6 text-center">
      <p className="text-xs font-semibold tracking-[0.4em] text-text-muted">STORY</p>
      ...
      <Link
        href="/"
        className="mt-8 self-center rounded-[length:var(--radius-md)] border border-border px-6 py-3 font-semibold transition-colors hover:bg-surface"
      >
        Go home
      </Link>
    </main>
