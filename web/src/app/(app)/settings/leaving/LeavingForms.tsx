...
export function LeavingForms() {
  ...
  return (
    <div className="max-w-lg space-y-10">
      ...
      >
        <h2 className="font-editorial text-[length:var(--text-heading)] font-semibold tracking-[var(--tracking-title)]">Deactivate</h2>
      ...
      >
        <h2 className="font-editorial text-[length:var(--text-heading)] font-semibold tracking-[var(--tracking-title)] text-danger">Delete</h2>
        <ul className="mt-3 space-y-1.5 text-[length:var(--text-label)] leading-relaxed text-text-secondary">
